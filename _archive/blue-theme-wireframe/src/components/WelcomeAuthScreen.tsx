...
export function WelcomeAuthScreen({ onEmail, onGoogle, onSignIn, onTerms, onPrivacy }: WelcomeAuthScreenProps) {
  return (
    <div className="h-full flex flex-col px-8 relative overflow-hidden pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]" style={{ background: 'linear-gradient(135deg, #4CA6FA 0%, #1D4ADD 100%)' }}>
      ...
      <p className="text-center max-w-xs mx-auto relative z-10 text-white pb-4 text-sm">
