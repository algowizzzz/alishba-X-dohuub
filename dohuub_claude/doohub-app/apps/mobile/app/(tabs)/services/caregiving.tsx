  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity style={styles.choiceCard} onPress={() => router.push('/services/caregiving/rides' as any)} activeOpacity={0.8}>
          <View style={styles.cardRow}>
            ...
            <View style={styles.cardContent}>
              ...
              <View style={styles.featureList}>
                {['Hourly rate booking', 'Multiple stops available', 'Round-trip option'].map(f => (
        ...
        <TouchableOpacity style={styles.choiceCard} onPress={() => router.push('/services/caregiving/companions' as any)} activeOpacity={0.8}>
          <View style={styles.cardRow}>
            <View style={styles.iconContainer}>
            ...
            <View style={styles.cardContent}>
              ...
              <View style={styles.featureList}>
                {['Flexible duration', 'Personalized care plans', 'Certified caregivers'].map(f => (
                  <View key={f} style={styles.featureItem}>
...
const styles = StyleSheet.create({
  ...
  choiceCard: {
    padding: spacing.lg, borderWidth: borderWidth.thin, borderColor: colors.border.default,
    borderRadius: borderRadius.xl, marginBottom: spacing.md, backgroundColor: colors.surface,
  ...
  cardContent: { flex: 1 },
  cardTitle: { fontSize: fontSize.lg, fontWeight: '600', color: colors.text.primary, marginBottom: spacing.sm },
  cardDescription: { fontSize: fontSize.sm, color: colors.text.secondary, lineHeight: 20, marginBottom: spacing.md },
  featureList: { gap: 6 },
  featureItem: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  featureDot: { width: 6, height: 6, borderRadius: 3 },
  featureText: { fontSize: fontSize.sm, color: colors.text.secondary },
});
