  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/rewards" element={<RewardsOverview />} />
        <Route path="/admin/rewards/milestones" element={<MilestoneConfiguration />} />
        <Route path="/admin/customers/:id/rewards" element={<CustomerRewardsDetail />} />
