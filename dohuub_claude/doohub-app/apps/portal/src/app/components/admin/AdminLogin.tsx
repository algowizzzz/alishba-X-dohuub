...
export function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await signInAs(email, password, "ADMIN");
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-[480px]">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-sm text-[#6B7280] hover:text-[#1A1A2E] mb-8 transition-colors group"
        >
        ...
        {/* Login Card */}
        <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-12 shadow-[0_4px_16px_rgba(46,122,217,0.20)]">
          <div className="text-center mb-8">
            <h2 className="text-[28px] font-bold text-[#1A1A2E] mb-2">Admin Panel Login</h2>
            <div className="w-[60px] h-[3px] bg-[#2E7AD9] mx-auto"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Email Field */}
            <div>
              <Label htmlFor="email" className="text-base font-semibold text-[#1A1A2E] mb-2 block">
                Email
              </Label>
              <Input
                id="email"
            ...
            {/* Password Field */}
            <div>
              <Label htmlFor="password" className="text-base font-semibold text-[#1A1A2E] mb-2 block">
                Password
              </Label>
              <div className="relative">
                <Input
                  ...
                  className="h-[52px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px] px-4 pr-12 focus:border-[#2E7AD9]"
                  onKeyDown={(e) => {
                    if (e.key === 'Enter') {
            ...
            <div className="text-center mt-5">
              <Link
                ...
                className="text-sm text-[#6B7280] hover:text-[#1A1A2E] hover:underline transition-colors"
              >
