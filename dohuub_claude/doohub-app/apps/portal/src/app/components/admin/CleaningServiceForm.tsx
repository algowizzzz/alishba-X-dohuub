      ...
      >
        <div className="max-w-[900px]">
          ...
          <div className="space-y-8">
            ...
            {/* Service Title */}
            <div>
              <Label htmlFor="service-title" className="text-sm font-semibold text-[#1A1A2E] mb-2 block">
                Service Title *
              </Label>
              <Input
                id="service-title"
            ...
            {/* Short Description */}
            <div>
              <Label htmlFor="short-desc" className="text-sm font-semibold text-[#1A1A2E] mb-2 block">
                Short Description *
              </Label>
              <p className="text-[13px] text-[#6B7280] mb-3">
              ...
              <div className="grid grid-cols-5 gap-3 mb-3">
                {imageGallery.map((image, index) => (
                  <div key={image.id} className="relative group">
                    ...
                    <div className="absolute top-1.5 left-1.5 w-5 h-5 bg-[#1A1A2E]/60 text-white rounded flex items-center justify-center cursor-move">
            ...
            {/* Long Description */}
            <div>
              <Label htmlFor="long-desc" className="text-sm font-semibold text-[#1A1A2E] mb-2 block">
                Full Description *
              </Label>
              <p className="text-[13px] text-[#6B7280] mb-3">
                ...
                {whatsIncluded.map((item) => (
                  <div key={item.id} className="flex items-center gap-3">
                    ...
                    <Label
                      ...
                      className="text-[15px] text-[#1A1A2E] cursor-pointer flex-1"
                    >
                      {item.text}
                    </Label>
                  </div>
            ...
            {/* Action Buttons */}
            <div className="flex flex-col sm:flex-row gap-3 pt-6 border-t border-[rgba(46,122,217,0.25)]">
              <Button
