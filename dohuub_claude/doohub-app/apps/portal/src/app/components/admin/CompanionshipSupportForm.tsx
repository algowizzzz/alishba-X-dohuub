      ...
      >
        <div className="max-w-[900px]">
          ...
          <div className="space-y-6">
            {/* Companion Photo */}
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              <h2 className="text-lg font-bold text-[#1A1A2E] mb-4">Companion Photo</h2>
              <div className="space-y-4">
                {thumbnail ? (
                  ...
                  <label className="flex flex-col items-center justify-center w-full h-[300px] border-2 border-dashed border-[rgba(46,122,217,0.25)] rounded-lg cursor-pointer hover:border-[#2E7AD9] transition-colors">
            ...
            {/* Basic Information */}
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              <h2 className="text-lg font-bold text-[#1A1A2E] mb-4">Basic Information</h2>
              <div className="space-y-4">
                {/* Companion Name */}
                <div>
                  <Label htmlFor="companionName" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    Companion Name *
                  </Label>
                  <Input
                    id="companionName"
                ...
                {/* Years of Experience */}
                <div>
                  <Label htmlFor="yearsExperience" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    Years of Experience *
                  </Label>
                  <Input
                    id="yearsExperience"
                ...
                {/* Hourly Rate */}
                <div>
                  <Label htmlFor="hourlyRate" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    Price (Hourly Rate) *
                  </Label>
                ...
                {/* About */}
                <div>
                  <Label htmlFor="about" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    About *
                  </Label>
                  <Textarea
                    id="about"
            ...
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              <h2 className="text-lg font-bold text-[#1A1A2E] mb-4">Certifications & Training</h2>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="cna" className="text-sm text-[#1A1A2E] cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="cprFirstAid" className="text-sm text-[#1A1A2E] cursor-pointer">
                    CPR & First Aid
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="dementiaCareSpecialist" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Dementia Care Specialist
                  </Label>
                </div>
                <div>
                  <Label htmlFor="otherCertification" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    Other
                  </Label>
                  <Input
            ...
            {/* Specialties */}
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              <h2 className="text-lg font-bold text-[#1A1A2E] mb-4">Specialties</h2>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Checkbox
                  ...
                  />
                  <Label htmlFor="dementiaCareSpecialty" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Dementia Care
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="mobilityAssistance" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Mobility Assistance
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="medicationManagement" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Medication Management
                  </Label>
                </div>
                <div>
                  <Label htmlFor="otherSpecialty" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    Other
                  </Label>
                  <Input
                    id="otherSpecialty"
            ...
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              <h2 className="text-lg font-bold text-[#1A1A2E] mb-4">Type of Support Offered</h2>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <Checkbox
                    id="conversation"
                  ...
                  />
                  <Label htmlFor="conversation" className="text-sm text-[#1A1A2E] cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="activities" className="text-sm text-[#1A1A2E] cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="mealPrep" className="text-sm text-[#1A1A2E] cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="medicationReminders" className="text-sm text-[#1A1A2E] cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="housekeeping" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Light Housekeeping
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="errands" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Errands & Shopping
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="appointments" className="text-sm text-[#1A1A2E] cursor-pointer">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label htmlFor="personalCare" className="text-sm text-[#1A1A2E] cursor-pointer">
                    Personal Care Assistance
                  </Label>
                </div>
                <div>
                  <Label htmlFor="otherSupport" className="text-sm font-semibold text-[#1A1A2E] mb-2">
                    Other
                  </Label>
                  <Input
                    id="otherSupport"
            ...
            {/* Languages */}
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              <h2 className="text-lg font-bold text-[#1A1A2E] mb-4">Languages</h2>
              <div className="space-y-4">
            ...
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-5 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
              ...
              <div className="space-y-4">
                <label className="flex flex-col items-center justify-center w-full h-[200px] border-2 border-dashed border-[rgba(46,122,217,0.25)] rounded-lg cursor-pointer hover:border-[#2E7AD9] transition-colors">
                    ...
                    {imageGallery.map((img, index) => (
                      <div key={index} className="relative aspect-square rounded-lg overflow-hidden">
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 p-1.5 bg-white rounded-full shadow-lg hover:bg-secondary"
                        >
                          <X className="w-3.5 h-3.5" />
                        </button>
                      </div>
            ...
            {/* Action Buttons */}
            <div className="flex justify-between pt-8 border-t border-[rgba(46,122,217,0.25)]">
              <Button
                variant="outline"
              ...
              <div className="flex gap-3">
                ...
                <Button onClick={handlePublish} className="h-11 px-6 bg-[#2E7AD9] hover:bg-[#1E5DB0]">
                  Publish
                </Button>
              </div>
            </div>
