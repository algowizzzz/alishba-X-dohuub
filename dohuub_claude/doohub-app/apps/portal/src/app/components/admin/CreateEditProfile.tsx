    ...
    <div className="min-h-screen bg-[#F0F7FF]">
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          {/* Form Container */}
          <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-10 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {regions.map((region) => (
                      <div
                        key={region.id}
                        className="flex items-center justify-between p-5 border border-[rgba(46,122,217,0.25)] rounded-[10px]"
                      >
                        <div className="flex items-center gap-3">
                          <MapPin className="w-5 h-5 text-[#6B7280]" />
                          <div>
                            <p className="text-base font-bold text-[#1A1A2E]">{region.name}</p>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                ...
                <div className="border-t border-[rgba(46,122,217,0.25)] pt-6">
                  <h3 className="text-lg font-bold text-[#1A1A2E] mb-2">"Powered by DoHuub" Badge</h3>
