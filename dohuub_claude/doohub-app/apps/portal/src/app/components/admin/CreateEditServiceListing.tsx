...
export function CreateEditServiceListing() {
  ...
  return (
    <div className="min-h-screen bg-[#F0F7FF]">
      ...
      <div className="flex">
        <AdminSidebar activeMenu="michelle" />
        ...
        <main className="ml-[280px] mt-[72px] p-8 flex-1">
          <div className="max-w-[900px] mx-auto">
            ...
            <div className="mb-8">
              <h2 className="text-xl font-bold text-[#1A1A2E] mb-4">Basic Information</h2>
              <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-8 space-y-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
                <div>
                  <Label htmlFor="serviceName" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                  ...
                  <Input
                    ...
                    className="h-[52px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px]"
                    maxLength={100}
                  />
                ...
                <div>
                  <Label htmlFor="serviceType" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                    Service Type <span className="text-[#DC2626]">*</span>
                  </Label>
                  <Select value={serviceType} onValueChange={setServiceType}>
                    <SelectTrigger className="h-[52px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px]">
                ...
                <div>
                  <Label htmlFor="description" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                  ...
                  <Textarea
                    ...
                    className="min-h-[180px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px] resize-none"
                    maxLength={1000}
                  />
                ...
                <div>
                  <Label className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                    Service Images
                  </Label>
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-2">
                    {images.map((image, index) => (
                      <div key={image.id} className="relative flex-shrink-0 group">
                        ...
                        {image.isPrimary && (
                          <div className="absolute top-2 left-2 bg-[#2E7AD9] text-white text-xs px-2 py-1 rounded">
                            Primary
                          </div>
                        )}
                      </div>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-bold text-[#1A1A2E] mb-4">Pricing & Duration</h2>
              <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-8 space-y-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="basePrice" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder="120"
                        className="h-[52px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px] pl-8"
                        step="0.01"
                        min="0"
                      />
                    </div>
                  ...
                  <div>
                    <Label htmlFor="duration" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                ...
                <div>
                  <Label className="text-[15px] font-semibold text-[#1A1A2E] mb-3 block">
                    Price Type
                  </Label>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-bold text-[#1A1A2E] mb-4">Regional Availability</h2>
              <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-8 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
                  ...
                  {regions.map((region, index) => (
                    <div
                      ...
                      className={`grid grid-cols-3 gap-6 items-center py-4 ${
                        index < regions.length - 1 ? 'border-b border-[#F0F7FF]' : ''
                      }`}
                    >
                      ...
                      <div className="flex items-center gap-3">
                        <Checkbox
                          ...
                          className="w-5 h-5"
                        />
                        <Label htmlFor={`region-${region.id}`} className="text-base text-[#1A1A2E] cursor-pointer flex items-center gap-2">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="relative w-[120px]">
                              ...
                              <Input
                                ...
                                className="h-10 text-sm border border-[rgba(46,122,217,0.25)] rounded-lg pl-7"
                                step="0.01"
                                min="0"
                              />
                            </div>
            ...
            <div className="mb-8">
              ...
              >
                <div>
                  <h2 className="text-xl font-bold text-[#1A1A2E] text-left">Booking Settings</h2>
                ...
                <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-8 space-y-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="min-h-[120px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px] resize-none"
                      maxLength={500}
                    />
                  </div>
                </div>
            ...
            {/* Navigation Buttons */}
            <div className="flex justify-between pt-8 border-t border-[rgba(46,122,217,0.25)] mb-8">
              <Button
                variant="outline"
