      ...
      >
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="text-base text-[#6B7280] mb-8">
            Profile: <span className="font-semibold text-[#1A1A2E]">{profileName}</span> • Category: <span className="font-semibold text-[#1A1A2E]">{profileCategory}</span>
          </p>
          ...
          {isBeautyProductsProfile ? (
            <div className="space-y-8">
              ...
              <div>
                ...
                {thumbnail ? (
                  <div className="relative w-full h-[240px] border border-[rgba(46,122,217,0.25)] rounded-xl overflow-hidden">
                    <img
                      src={thumbnail.url}
                      alt="Thumbnail"
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 w-8 h-8 bg-[#2E7AD9] hover:bg-[#1E5DB0] text-white rounded-full flex items-center justify-center transition-colors"
                    >
                      <X className="w-4 h-4" />
                    </button>
                  </div>
              ...
              <div>
                <Label htmlFor="productCategory" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Product Category *
                </Label>
              ...
              {/* Item Name */}
              <div>
                <Label htmlFor="itemName" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Item Name *
                </Label>
                <Input
                  id="itemName"
              ...
              {/* Short Description */}
              <div>
                <Label htmlFor="shortDescription" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Short Description *
                </Label>
                <Textarea
                  id="shortDescription"
              ...
              {/* Price */}
              <div>
                <Label htmlFor="price" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Price *
                </Label>
                ...
                {imageGallery.length > 0 && (
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
                    {imageGallery.map((img, index) => (
                      <div
                        key={img.id}
                        className="relative border border-[rgba(46,122,217,0.25)] rounded-lg overflow-hidden aspect-square group"
                      >
                        <img
                          src={img.url}
                          alt={`Gallery ${index + 1}`}
                        ...
                        {/* Image number */}
                        <div className="absolute top-2 left-2 w-6 h-6 bg-[#2E7AD9] text-white text-xs rounded-full flex items-center justify-center font-semibold">
                          {index + 1}
                        </div>
                      </div>
                    ))}
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="border border-[rgba(46,122,217,0.25)] rounded-lg p-4 max-h-[300px] overflow-y-auto">
                    ...
                    {[
                      ...
                      <div key={cuisine} className="flex items-center gap-2">
                        ...
                        <Label
                          ...
                          className="text-sm text-[#1A1A2E] cursor-pointer"
                        >
                          {cuisine}
                        </Label>
                      </div>
              ...
              {/* Portion Size */}
              <div>
                <Label htmlFor="portionSize" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
            ...
            <div className="space-y-8">
              ...
              {/* Property Title */}
              <div>
                <Label htmlFor="propertyTitle" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Property Title *
                </Label>
                <Input
                  id="propertyTitle"
              ...
              {/* Region */}
              <div>
                <Label htmlFor="location" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Region *
                </Label>
              ...
              {/* Property Type */}
              <div>
                <Label htmlFor="propertyType" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Property Type *
                </Label>
              ...
              <div className="grid grid-cols-2 gap-6">
                {/* Bedrooms */}
                <div>
                  <Label htmlFor="bedrooms" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                    Bedrooms *
                  </Label>
                  <Input
                    id="bedrooms"
                ...
                {/* Bathrooms */}
                <div>
                  <Label htmlFor="bathrooms" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                    Bathrooms *
                  </Label>
                  <Input
                    id="bathrooms"
              ...
              <div className="grid grid-cols-2 gap-6">
                {/* Max Guests */}
                <div>
                  <Label htmlFor="maxGuests" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                    Max Guests *
                  </Label>
                  <Input
                    id="maxGuests"
              ...
              {/* Price Per Night */}
              <div>
                <Label htmlFor="pricePerNight" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Price Per Night *
                </Label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#6B7280] font-semibold">
              ...
              <div>
                ...
                <div className="border border-[rgba(46,122,217,0.25)] rounded-lg p-6 space-y-4 max-h-[400px] overflow-y-auto">
                  {/* Essentials */}
                  <div>
                    <p className="text-sm font-semibold text-[#1A1A2E] mb-3">Essential Amenities</p>
                    <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="pt-4 border-t border-[rgba(46,122,217,0.25)]">
                    <p className="text-sm font-semibold text-[#1A1A2E] mb-3">Kitchen & Dining</p>
                    <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Property Features */}
                  <div className="pt-4 border-t border-[rgba(46,122,217,0.25)]">
                    <p className="text-sm font-semibold text-[#1A1A2E] mb-3">Property Features</p>
                    <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Safety & Security */}
                  <div className="pt-4 border-t border-[rgba(46,122,217,0.25)]">
                    <p className="text-sm font-semibold text-[#1A1A2E] mb-3">Safety & Security</p>
                    <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="pt-4 border-t border-[rgba(46,122,217,0.25)]">
                    <p className="text-sm font-semibold text-[#1A1A2E] mb-3">Accessibility & Extras</p>
                    <div className="grid grid-cols-2 gap-3">
                  ...
                  {/* Location Views */}
                  <div className="pt-4 border-t border-[rgba(46,122,217,0.25)]">
                    <p className="text-sm font-semibold text-[#1A1A2E] mb-3">Location & Views</p>
                    <div className="grid grid-cols-2 gap-3">
              ...
              {/* Long Description */}
              <div>
                <Label htmlFor="longDescription" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Long Description *
                </Label>
                <Textarea
                  id="longDescription"
              ...
              {/* House Rules */}
              <div>
                <Label htmlFor="houseRules" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  House Rules
                </Label>
                <Textarea
                  id="houseRules"
              ...
              <div>
                ...
                <div className="bg-[#F8FAFF] border border-[rgba(46,122,217,0.25)] rounded-[16px] p-6 w-fit">
                  ...
                  {unavailableDates.length > 0 && (
                    <div className="mt-4 pt-4 border-t border-[rgba(46,122,217,0.25)]">
              ...
              <div>
                ...
                {imageGallery.length > 0 && (
                  <div className="grid grid-cols-3 gap-4 mb-4">
                    {imageGallery.map((img, index) => (
                      <div key={img.id} className="relative group aspect-square rounded-lg overflow-hidden border border-[rgba(46,122,217,0.25)]">
                        <img
                          src={img.url}
                          alt={`Gallery ${index + 1}`}
                          className="w-full h-full object-cover"
            ...
            <div className="space-y-8">
              ...
              {/* Hourly Rate */}
              <div>
                <Label htmlFor="hourlyRate" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Hourly Rate *
                </Label>
                <div className="relative">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-4 border border-[rgba(46,122,217,0.25)] rounded-[10px] hover:border-[#2E7AD9] transition-colors">
                    <Checkbox
                      id="vehicle-standard"
              ...
              {/* Special Features */}
              <div>
                <Label htmlFor="specialFeatures" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Special Features
                </Label>
                <p className="text-sm text-[#6B7280] mb-3">
              ...
              {/* Coverage Area */}
              <div>
                <Label htmlFor="coverageArea" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Coverage Area *
                </Label>
                <p className="text-sm text-[#6B7280] mb-3">
              ...
              <div>
                <Label htmlFor="totalSeats" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Total Number of Seats *
                </Label>
                <Input
                  id="totalSeats"
            ...
            <div className="space-y-8">
              ...
              {/* Service Title */}
              <div>
                <Label htmlFor="serviceTitle" className="text-base font-semibold text-[#1A1A2E] mb-3 block">
                  Service Title *
                </Label>
                <Input
                  id="serviceTitle"
                  ...
                  {includedItems.map((item) => (
                    <div key={item.id} className="flex items-center gap-3">
                      ...
                      <Label
                        ...
                        className="flex-1 text-sm text-[#1A1A2E] cursor-pointer"
                      >
                        {item.text}
                      </Label>
                      {item.isCustom && (
          ...
          {/* Action Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 mt-10 pt-8 border-t border-[rgba(46,122,217,0.25)]">
            <Button
