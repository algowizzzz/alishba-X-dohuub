...
function MetricCard({ label, value, trend, trendText, icon }: MetricCardProps) {
  ...
  return (
    <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-5 sm:p-6 hover:shadow-[0_6px_16px_rgba(46,122,217,0.22)] transition-all cursor-pointer">
      ...
      <p className="text-3xl sm:text-4xl font-bold text-[#1A1A2E] mb-2">
        {value}
      </p>
...
const categoryData = [
  { name: "Cleaning", value: 234, color: "#2E7AD9" },
    ...
    <div className="min-h-screen bg-[#F0F7FF]">
      ...
      >
        <div className="max-w-[1400px] mx-auto">
          ...
          {/* Key Metrics */}
          <div className="mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-bold text-[#1A1A2E] mb-4 sm:mb-5">
              Key Metrics
            </h2>
          ...
          {/* Revenue Trend Chart */}
          <div className="mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-bold text-[#1A1A2E] mb-4">
              Revenue Trend
            </h2>
            <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-4 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
            ...
            <div className="lg:hidden space-y-4">
              {sortedProfiles.map((profile) => (
                ...
                >
                  ...
                  <div className="flex gap-2 pt-4 border-t border-[rgba(46,122,217,0.25)]">
              ...
              <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-4 sm:p-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
                <ResponsiveContainer width="100%" height={300}>
                  <BarChart data={topServicesData} layout="vertical">
                    ...
                    />
                    <Bar dataKey="bookings" fill="#1A1A2E" radius={[0, 8, 8, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
