    ...
    <div className="min-h-screen bg-[#F0F7FF]">
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          {/* Progress Bar */}
          <div className="w-full h-1.5 bg-[rgba(46, 122, 217, 0.12)] rounded-full mb-6 sm:mb-8">
            <div
          ...
          {/* Form Container */}
          <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-xl p-4 sm:p-6 lg:p-10 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
            {/* Step 1: Basic Information */}
            {currentStep === 1 && (
              <div className="space-y-6">
                <div>
                  <Label htmlFor="businessName" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                ...
                <div>
                  <Label htmlFor="category" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                    <div className="relative w-full sm:w-auto">
                      {logoPreview ? (
                        <div className="w-full sm:w-[200px] h-[200px] rounded-xl overflow-hidden border-2 border-[rgba(46,122,217,0.25)]">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="min-h-[140px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px] resize-none"
                    maxLength={500}
                  />
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {regions.map((region) => (
                      <div
                        key={region.id}
                        className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 p-4 sm:p-5 border border-[rgba(46,122,217,0.25)] rounded-[10px]"
                      >
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <MapPin className="w-5 h-5 text-[#6B7280] flex-shrink-0" />
                          <div className="min-w-0 flex-1">
                            <p className="text-sm sm:text-base font-bold text-[#1A1A2E] break-words">{region.name}</p>
            ...
            {currentStep === 3 && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-[#1A1A2E] mb-4">Contact Information</h3>

                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="phone" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="h-[52px] text-base border-2 border-[rgba(46,122,217,0.25)] rounded-[10px] pl-12"
                        />
                      </div>
                      <p className="text-[13px] text-[#6B7280] mt-2">
                    ...
                    <div>
                      <Label htmlFor="email" className="text-[15px] font-semibold text-[#1A1A2E] mb-2 block">
            ...
            {currentStep === 4 && (
              <div className="space-y-6">
                <div>
                  ...
                  <div className="bg-white border-2 border-[rgba(46,122,217,0.25)] rounded-xl p-8 mb-6">
                    <div className="flex gap-6 mb-6">
                      ...
                      <div>
                        <h4 className="text-2xl font-bold text-[#1A1A2E] mb-2">{businessName || "Business Name"}</h4>
                      </div>
                    </div>
                ...
                <div className="border-t border-[rgba(46,122,217,0.25)] pt-6">
                  <h3 className="text-lg font-bold text-[#1A1A2E] mb-4">Activation Status</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <Label htmlFor="active" className="text-base font-bold text-[#1A1A2E] cursor-pointer">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <Label htmlFor="inactive" className="text-base font-bold text-[#1A1A2E] cursor-pointer">
                            Save as Inactive
                          </Label>
                          <p className="text-sm text-[#6B7280]">
            ...
            {/* Navigation Buttons */}
            <div className="flex justify-between mt-10 pt-8 border-t border-[rgba(46,122,217,0.25)]">
              <Button
                variant="outline"
                onClick={handleBack}
