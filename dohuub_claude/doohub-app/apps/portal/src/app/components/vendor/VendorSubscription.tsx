        ...
        <div className="bg-white rounded-2xl border border-[rgba(46,122,217,0.25)] p-8 shadow-[0_4px_16px_rgba(46,122,217,0.20)]">
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-2xl bg-[#F0F7FF] flex items-center justify-center mx-auto mb-4">
              <CreditCard className="w-8 h-8 text-[#1A1A2E]" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  {/* Popular Badge */}
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#2E7AD9] text-white px-3 py-1 rounded-full text-xs font-semibold">
                    Most Popular
                  </div>
                  {selectedPlan === "yearly" && (
                    <div className="absolute top-4 right-4 w-6 h-6 bg-[#2E7AD9] rounded-full flex items-center justify-center">
            ...
            {/* Divider */}
            <div className="border-t border-[rgba(46,122,217,0.25)]"></div>
            ...
            {/* Trial Notice */}
            <div className="bg-[#E8F1FC] border border-[#93C5FD] rounded-xl p-4">
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 rounded-full bg-[#1E5DB0] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#1A4791]">
