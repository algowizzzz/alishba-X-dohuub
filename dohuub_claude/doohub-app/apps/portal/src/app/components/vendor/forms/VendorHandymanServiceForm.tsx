...
const DEFAULT_INCLUDED_ITEMS = [
  ...
  "Parts & materials sourcing assistance",
];
...
export function VendorHandymanServiceForm() {
  ...
  const [formData, setFormData] = useState({
    title: isEditing ? "General Home Repairs" : "",
    serviceType: isEditing ? "General Repairs" : "",
    description: isEditing
      ? "Expert handyman services for all your home repair needs."
      : "",
    priceType: isEditing ? "hourly" : "hourly",
    price: isEditing ? "75" : "",
    duration: isEditing ? "2" : "",
    warranty: isEditing ? "90" : "",
    materials: isEditing ? "included" : "additional",
        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-2xl sm:text-[28px] lg:text-[32px] font-bold text-[#1A1A2E] mb-2">
              {isEditing ? "Edit Handyman Service" : "Create Handyman Service"}
            </h1>
            <p className="text-sm sm:text-[15px] text-[#6B7280]">
              {isEditing
                ? "Update your handyman service details"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <Label htmlFor="price" className="mb-1.5">
                  {formData.priceType === "quote" ? "Starting From" : "Price"}{" "}
              ...
              <div>
                <Label htmlFor="warranty" className="mb-1.5">
              ...
              <div>
                <Label htmlFor="materials" className="mb-1.5">
                  Materials
                </Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="additional">Additional Cost</SelectItem>
          ...
          <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
            ...
            <p className="text-sm text-[#6B7280] mb-6">
              Add items that are included with this handyman service
            </p>
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder="e.g., Professional tools & equipment"
                onKeyPress={(e) => {
                  if (e.key === "Enter") {
                    e.preventDefault();
          ...
          <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
            ...
            <p className="text-sm text-[#6B7280] mb-6">
              Upload images to showcase your handyman service
            </p>
