...
export function VendorHandymanServiceForm({
  ...
  return (
    <div className="max-w-[900px] mx-auto">
      ...
      <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-[rgba(46,122,217,0.25)] rounded-xl p-8 text-center hover:border-[#9CA3AF] transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              {formData.imageGallery.map((image, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 p-3 border border-[rgba(46,122,217,0.25)] rounded-lg"
                >
                  <div className="w-12 h-12 bg-[#F0F7FF] rounded flex items-center justify-center">
      ...
      {/* Pricing */}
      <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
        <h2 className="text-xl font-bold text-[#1A1A2E] mb-6">Pricing</h2>
      ...
      {/* What's Included */}
      <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
        <h2 className="text-xl font-bold text-[#1A1A2E] mb-6">What's Included</h2>
          ...
          {formData.whatsIncluded.map((item) => (
            <div key={item.id} className="flex items-start gap-3">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-[rgba(46,122,217,0.25)] text-[#1A1A2E] focus:ring-[#2E7AD9]"
              />
              <Label
      ...
      <div className="flex gap-4 pb-8">
        ...
        <Button
          ...
          disabled={isSaving}
          className="flex-1 bg-[#2E7AD9] hover:bg-[#1E5DB0]"
        >
