      ...
      <div className="bg-white border border-[rgba(46,122,217,0.25)] rounded-2xl p-6 sm:p-8 mb-6 shadow-[0_4px_16px_rgba(46,122,217,0.18)]">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border border-[rgba(46,122,217,0.25)] rounded-lg p-4 max-h-[400px] overflow-y-auto space-y-6">
                    ...
                    {items.map((amenity) => (
                      <div key={amenity} className="flex items-start gap-2">
                        <input
                          ...
                          className="mt-0.5 w-4 h-4 rounded border-[rgba(46,122,217,0.25)] text-[#1A1A2E] focus:ring-[#2E7AD9]"
                        />
                        <Label
